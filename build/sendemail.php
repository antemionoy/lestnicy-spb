<?php
	...
	$ms = htmlspecialchars($_POST["message"]);
	...
	if($ms)
		$ms = "<p><strong>Cообщение:</strong> ".$ms."</p>";
	else $ms = "";
	...
	$message = $name.$surname.$phone.$email.$ms.$reviewStars.$choice__discount.$date__arrival.$date__departure.$number__persons.$checkbox;
